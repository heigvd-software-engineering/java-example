package ch.heigvd.examples.calcite.basic;
...
public class Basic {
    ...
    public static void main(String[] args) throws SQLException {
        ...
        String sql = "SELECT player.name, equipment.name FROM player INNER JOIN equipment ON player.id = equipment.player_id ";
